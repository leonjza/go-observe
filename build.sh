...
GOOS=linux GOARCH=386 go build  -o build/$FILENAME main.go

FILENAME="go-observe-$VERSION-linux-amd64"
echo "Compiling amd64 Linux to $FILENAME"
GOOS=linux GOARCH=amd64 go build  -o build/$FILENAME main.go

FILENAME="go-observe-$VERSION-linux-arm"
echo "Compiling arm Linux to $FILENAME"
GOOS=linux GOARCH=arm go build  -o build/$FILENAME main.go
